...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <h1 class="text-cyan-700 font-bold text-4xl pt-10 pl-10">Data Berita</h1>
    <div class="container ">
        <!-- Menampilkan error jika ada -->
        <?=isset($error) ? "<h4 id='error'>Error: $error</h4>" : ""?>
        <div class=" container relative overflow-x-auto">
            <div class="mb-5 flex">
                    <a class=" bg-cyan-700 text-white font-semibold p-3 rounded-lg ml-10 shadow-md hover:bg-cyan-600 mb-2 mt-10" href="buat-berita.php">Buat Berita</a>
                    <a class=" bg-cyan-700 text-white font-semibold p-3 rounded-lg ml-3 shadow-md hover:bg-cyan-600 mb-2 mt-10" href="berita.php">Lihat Berita</a>
                    <div class="pl-96 ml-20 pt-4">
                            <form method="GET" action="hasil-pencarian-berita.php" class="">
                                <label for="keyword" class="block text-cyan-700 text-sm font-bold ">Masukkan Kata Kunci:</label>
                                ...
                                <button type="submit"
                                    class="mt-3 py-2 px-4 bg-cyan-700 hover:bg-cyan-600 text-sm text-white font-semibold rounded-lg shadow-md focus:outline-none focus:shadow-outline">
                                    Cari
                                </button>
                            </form>
                        </div>
            ...
            <div class="mx-10 relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="md:table-fixed text-sm text-left rtl:text-right text-black rounded-lg shadow-lg">
                        <thead class="text-xs text-white uppercase bg-cyan-700">
                            <tr>
                                ...
                                <th scope="col" class="px-4  max-w-sm py-3 text-center">
                                    SubJudul
                                </th>
                                <th scope="col" class="px-40 py-3 max-w-sm  text-center ">
                                    Konten
                                </th>
                                <th scope="col" class="text-center max-w-xs py-3">
                                    Gambar
                                </th>
                        ...
                        <tbody>
                            <tr class="bg-white border-b text-black ">
                                ...
                                <td class="px-4 max-w-sm py-4 text-justify text-left">
                                    <?= substr($data->content, 0, 200) . (strlen($data->content) > 200 ? '...' : '') ?>
                                </td>
                                <td class="px-4 max-w-xs py-4">
                                    <?= $data->image ?>
                                </td>
                                <td class="flex px-4 py-12">
                                    <a href="edit-berita.php?id=<?= $data->id_berita ?>" class="font-medium text-white bg-cyan-700 hover:bg-cyan-600 py-1.5 px-2 rounded-md mr-1">Ubah</a>
                                    <a href="hapus-berita.php?id=<?= $data->id_berita ?>" class="font-medium text-white bg-red-500 hover:bg-red-400 py-1.5 px-2 rounded-md">Hapus</a>
                                </td>
                            </tr>
                        </tbody>
                        <?php endforeach; ?>
