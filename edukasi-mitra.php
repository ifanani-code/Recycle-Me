...
$dataEdukasi = $edukasi->getAllPosts();
?>
...
<body>
    ...
    <body class="bg-cyan-950">
        ...
        <!-- <div class="h-10 my-5 bg-gray-100"></div> -->
                ...
                <div class="flex h-[100px] items-center justify-between fixed w-full z-20 top-0 start-0 px-28 bg-cyan-950 shadow-lg">
                    <div class="flex items-center ">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-80 pl-10 flex items-baseline space-x-10 relative">
                                <a href="home-mitra.php" class=" text-white hover:border-b-2 hover:text-cyan-700 hover:border-cyan-700  px-3 py-2 text-md font-semibold" aria-current="page">Beranda</a>
                                <div class="relative">
                                    <div class="relative">
                                ...
                                <a href="mitrajemputSampah.php" class="text-white hover:border-b-2 hover:text-cyan-700 hover:border-cyan-700 px-3 py-2 text-md font-semibold">Jemput Sampah</a>
                                ...
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    artikelDropdown.addEventListener('mouseenter', function() {
                                        timeoutId = setTimeout(function() {
                                            if (dropdownMenu.innerHTML === '') {
                                                ...
                                                edukasiButton.href = 'edukasi-mitra.php'; // Ganti dengan halaman edukasi yang sesuai
                                                ...
                                                beritaButton.href = 'berita-mitra.php'; // Ganti dengan halaman berita yang sesuai
                                    ...
                                    document.addEventListener('click', function(event) {
                                        if (!artikelDropdown.contains(event.target) &&
                                            event.target.href !== window.location.href + 'edukasi-mitra.php' &&
                                            event.target.href !== window.location.href + 'berita-mitra.php') {
                                            dropdownMenu.classList.add('hidden');
                                            dropdownMenu.innerHTML = '';
                                        }
                                    });
    ...
    <div class="container mx-auto justify-center items-center bg-cyan-950 mt-10">
        <h1 class="text-white font-bold text-4xl mb-2 ml-32">Edukasi</h1>
        <h1 class="font-semibold text-lg mb-10 px-32 text-gray-400">Jelajahi kisah di balik setiap sampah - bagaimana sesuatu yang dianggap tak berguna dapat menjadi kisah inspiratif pembelajaran.</h1>
            <div class="card-group grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4  px-32  mb-20 mt-10">
                <?php foreach ($dataEdukasi as $data): ?>
                    <div class="relative border-gray-200 rounded-lg shadow-lg bg-cyan-700 dark:border-gray-200 w-7xl mb-4">
                        ...
                        <div class="px-6 pb-6">
                            ...
                            <a href="view-edukasi-mitra.php?id=<?= $data->id ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-cyan-800 rounded-lg hover:bg-cyan-600 focus:ring-4 focus:outline-none mb-4   ">
                                Baca selengkapnya
                            </a>
                            <!-- <div class="item-end">
