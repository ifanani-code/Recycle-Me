                    ...
                    <div class="flex items-center ">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-80 flex items-baseline space-x-10 relative">
                                ...
                                <a href="poin.php" class="text-white hover:border-b-2 hover:text-cyan-700 hover:border-cyan-700 py-2 text-md font-semibold">Poin</a>
                            </div>
                            <script>
                ...
                <?php foreach ($dataEdukasi as $data): ?>
                    <div class="relative border-gray-200 rounded-lg shadow-lg bg-cyan-700 dark:border-gray-200 w-7xl mb-4">
                        ...
                        <div class="px-6 pb-6">
                            ...
                            <a href="view-edukasi.php?id=<?= $data->id ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-cyan-800 rounded-lg hover:bg-cyan-600 focus:ring-4 focus:outline-none mb-4   ">
                                Baca selengkapnya
                            </a>
                            <!-- <div class="item-end">
