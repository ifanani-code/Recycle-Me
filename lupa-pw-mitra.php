...
if (isset($_POST['change'])) {
    ...
    $exist = $user->isEmailAvailable($email);
    if($exist === true) {
        NotificationManager::setAlert(
            "danger",
            "Gagal ubah password"
        );
        header('Location: lupa-pw-mitra.php');
    } else {
...
<body>
    ...
    <?= $alert ? $alert : ''; ?>
        <div class="absolute md:w-full md:absolute">
            <img src="aset/bg-mitraa.webp" alt="" class="absolute object-cover object-center -z-10 rounded-lg h-screen w-full">
