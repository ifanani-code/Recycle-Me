...
$admin = new Admins();
$namaadmin = $admin->getAdmin($email);
...
<body>
    ...
    <div class="sm:ml-64">
        <div class="pt-10 grid justify-center">
            <h1 class="my-4 text-4xl font-bold text-center text-cyan-700">Kelola Mitra</h1>
                    ...
                    <tbody>
                        <?php foreach ($data as $mitra): ?>
                            <tr class="bg-white border-b text-center font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 max-w-[1044px] text-left">
                                    <?= $mitra->no_hp ?>
                                </td>
                                <td class="px-6 py-4">
                                    <a href="delete-mitra.php?user_id=<?= $mitra->user_id ?>"
                                        class="font-medium text-white bg-red-500 hover:bg-red-400 py-1.5 px-2 rounded-md"
                                        onclick="return confirm('yakin ingin hapus akun <?= $mitra->nama ?>?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
