...
<body>
        ...
        <div class="mx-auto max-w-7xl">
          ...
          -->
            ...
            Menu open: "block", Menu closed: "hidden"
                ...
                <div class="flex align-center flex-1 items-center sm:items-stretch sm:justify-start">
                ...
                <div class="relative inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto ml-6 sm:pr-0">
    ...
    <div class="container mx-auto justify-center items-center bg-cyan-950 pt-10">
                ...
                <?php foreach ($dataEdukasi as $data): ?>
                    <div class="relative border-gray-200 rounded-lg shadow-lg bg-cyan-700 dark:border-gray-200 w-7xl mb-4">
                        ...
                        <div class="px-6 pb-6">
                            ...
                            <a href="view-edukasi-before.php?id=<?= $data->id ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-cyan-800 rounded-lg hover:bg-cyan-600 focus:ring-4 focus:outline-none mb-4   ">
                                Baca selengkapnya
                            </a>
                            <!-- <div class="item-end">
