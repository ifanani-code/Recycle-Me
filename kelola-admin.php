...
<body>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-cyan-950">
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="home-admin.php" class="flex items-center p-2 text-gray-900 rounded-lg group hover:bg-gray-100">
                ...
                <li id="kelola-admin">
                    <a href="kelola-admin.php"
                        class="flex items-center p-2 rounded-lg group bg-gray-100">
                        <svg version="1.1" class="w-5 h-5 text-gray-900"
        ...
        C285.563,81.188,120.842,80.939,120.842,206.782z" />
                        ...
                        <span class="flex-1 ms-3 text-gray-900">Kelola Admin</span>
                    </a>
                </li>
                <li>
    ...
    <div class="sm:ml-64">
        <?= $alert ? $alert : ''; ?>
        <div class="grid justify-center pt-10 w-full">
            <h1 class="my-4 text-4xl font-black text-center text-cyan-700">Kelola Admin</h1>
            <div class="relative my-5 self-end">
                <a href="tambah-admin.php"
                    class="py-2 px-2 text-white text-sm rounded-md bg-cyan-700 hover:bg-cyan-600 focus:ring-2 focus:ring-white">tambah
                    admin</a>
            </div>
            <div class="relative overflow-auto sm:rounded-lg shadow-xl ">
                    ...
                    <tbody>
                        <?php foreach ($pengguna as $admin): ?>
                            <tr class="bg-white border-b text-center font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4">
                                    <a href="delete-admin.php?admin_id=<?= $admin->admin_id ?>"
                                        class="font-medium text-white bg-red-500 hover:bg-red-400 py-1.5 px-2 rounded-md"
                                        onclick="return confirm('yakin ingin hapus akun dengan id=<?= $admin->admin_id ?>?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="flex gap-x-2 ms-2 mt-2">
                ...
                <?php for($i = 1; $i <= $jml_hal; $i++): ?>
                    ...
                    <a href="?halaman=<?=$i?>" class="px-4 py-2 bg-cyan-700 text-white font-semibold rounded-md"><?= $i; ?></a>
                    <?php else : ?>
                    <a href="?halaman=<?=$i?>" class="px-4 py-2 bg-cyan-700/80 text-white font-semibol rounded-md hover:bg-cyan-600/80"><?= $i; ?></a>
                    <?php endif ; ?>
                <?php endfor; ?>
            </div>
        </div>
