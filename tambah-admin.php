...
if (isset($_POST['regist'])) {
    ...
    $cek = $admin->isEmailAvailable($email);
    if ($cek === true) {
        if ($password === $password2) {
            $result = $admin->TambahAdmin($name, $email, $password);
            if ($result === true) {
...
<body>
    ...
    <div class="ml-64">
        ...
        <div class="flex justify-center">
            <div class="p-10 w-full md:max-w-xl md:px-0">
                <h1 class="text-center text-cyan-700 font-bold text-4xl pt-5 pb-10">Tambah Admin</h1>
                <form method="post" action="">
                    ...
                    <button type="submit" name="regist"
                        class="text-white bg-cyan-700 hover:bg-cyan-600 focus:ring-2 focus:ring-white font-medium rounded-md text-sm w-full sm:w-auto p-2 text-center">Tambah</button>
                    <a href="kelola-admin.php"
                    class="text-white bg-cyan-700 hover:bg-cyan-600 focus:ring-2 focus:ring-white font-medium rounded-md text-sm w-full sm:w-auto p-2 text-center">Kembali</a>
                </form>
            </div>
        </div>
    </div>
