                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-black rounded-l shadow-lg">
                        <thead class="text-xs text-white uppercase bg-cyan-700">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 max-w-md text-center">Konten</th>
                            ...
                            <tbody>
                                <tr class="bg-white border-b text-black">
                                    ...
                                    <td class="flex px-4 py-4">
                                        <a href="edit-post.php?id=<?= $data->id_berita ?>" class="font-medium text-white hover:underline bg-cyan-700 px-3 py-1 rounded-lg">Edit</a>
                                        <a href="hapus-post.php?id=<?= $data->id_berita ?>" class="font-medium text-red-600 dark:text-white hover:underline ms-1 bg-red-700 px-3 py-1 rounded-lg">Hapus</a>
                                    </td>
                                </tr>
                            </tbody>
                        <?php endforeach; ?>
