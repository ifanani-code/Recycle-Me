...
<body class="bg-cyan-950">
    ...
    <div class="relative">
        <!-- Photo and Overlay -->
        <img src="aset/bgmitra.jpg" alt="Layered Photo" class="w-full h-auto object-cover">
        <div class="absolute inset-0 bg-black bg-opacity-50">
            ...
            <!-- Overlay Content -->
            <div
                class="flex relative mx-auto justify-center items-center max-w-7xl h-screen px-6 py-12 lg:py-24 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                    <h2
                        class="text-4xl text-center font-bold text-white sm:text-6xl animate__animated animate__fadeInDown">
                        Halo,
                        <?= $data->nama ?>
                    </h2>
                    ...
                    <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2">
                        <a href="#artikel"><svg class="h-8 w-8 text-white animate-bounce"
    ...
    <!-- Highlight artikel -->
    <div class="relative w-full bg-cyan-950 py-14 lg:mt-[155px] sm:py-10">
        <h2 class="text-4xl text-center font-bold text-white mb-10 sm:text-6xl">Berita hari ini</h2>
