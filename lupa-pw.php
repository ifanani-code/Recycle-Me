...
if (isset($_POST['change'])) {
    ...
    if ($password === $password2) {
        $result = $user->ChangePW($email, $password, $role);
        if ($result == true) {
...
<body>
    <section>
        ...
        <div class="relative flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="w-full bg-white rounded-2xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
