...
<body>
    <section>
        ...
        <div class="absolute md:w-full md:absolute">
            ...
            <img src="aset/bg.webp" alt="" class="absolute object-cover object-center -z-10 rounded-lg h-screen w-full">
        ...
        <div class="relative flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="flex justify-center items-center mb-4">
                <img src="aset/bg rm.png" alt="" class="w-[80px] h-[80px]">
                <!-- <h1 class="text-4xl font-bold text-white text-center md:text-4xl py-5">
                    Recycle Me
                </h1> -->
            ...
            <div class="w-full bg-white rounded-2xl shadow md:mt-0 sm:max-w-md xl:p-0 ">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <h1 class="text-2xl font-semibold text-cyan-700 text-center md:text-2xl pt-4">
                        Login
                    </h1>
                    <form class="space-y-4 md:space-y-6" method="post">
                        ...
                        <div class="">
                            <a href="lupa-pw.php" class="text-sm font-medium text-cyan-600 hover:underline">Lupa
                                password?</a>
                        </div>
                        ...
                        <p class="text-sm font-light text-gray-500">
                            Belum punya akun?
                            <a href="regist.php" class="font-medium text-cyan-600 hover:underline">Daftar</a>
                            atau
                            <a href="login-mitra.php" class="font-medium text-cyan-600 hover:underline">Masuk sebagai
                                mitra</a>
                        </p>
                        <p class="text-sm">
