...
<body class="bg-cover bg-center bg-fixed" style="background-image: url('aset/bg.jpeg');">
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-cyan-950">
            <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-5">
                <span class="self-center text-lg font-semibold whitespace-nowrap text-white">Halo, <?= $data->nama ?></span>
            </a>
            <ul class="space-y-2 font-medium">
                ...
                <li id="kelola-admin">
                    <a href="kelola-admin.php" class="flex items-center p-2 text-gray-900 rounded-lg group hover:bg-gray-100">
		...
		C285.563,81.188,120.842,80.939,120.842,206.782z" />
                ...
                <li>
                    <button class="w-full flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group" data-dropdown-toggle="dropdown-artikel">
                        <svg class="flex-shrink-0 w-7 h-7 text-gray-50 transition duration-75 group-hover:text-gray-900" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="10 0 100 90" xml:space="preserve">
                            <g>
                                <g>
                                    <path
                                ...
                                <g>
                                    <path d="M76,29v32c0,2.2-1.8,4-4,4H28c-2.2,0-4-1.8-4-4V29c-3.3,0-6,2.7-6,6v30c0,3.3,2.7,6,6,6h19c1.1,0,2,0.9,2,2v c0,1.1,0.9,2,2,2h6c1.1,0,2-0.9,2-2v0c0-1.1,0.9-2,2-2h19c3.3,0,6-2.7,6-6V35C82,31.7,79.3,29,76,29z" />
                                </g>
                                <g>
                                    <path
                        ...
                        <span class="flex-1 ms-2 text-gray-100 group-hover:text-gray-900 text-left">Kelola Artikel</span>
                        <svg class="flex-shrink-0 w-9 h-9 text-gray-50 transition duration-75 group-hover:text-gray-900" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <path fill="none" d="M0 0h24v24H0z" />
                                <path d="M12 15l-4.243-4.243 1.415-1.414L12 12.172l2.828-2.829 1.415 1.414z" stroke="currentColor" fill="currentColor" />
                            </g>
                    </button>
                ...
                <li>
                    <button class="w-full flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group"
                        ...
                        <span class="flex-1 ms-1 text-gray-100 group-hover:text-gray-900">Kelola pengguna</span>
                        <svg class="flex-shrink-0 w-9 h-9 text-gray-50 transition duration-75 group-hover:text-gray-900"
                    ...
                    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                            ...
                            <li>
                                <a href="kelola-mitra.php" class="block px-4 py-2 hover:bg-gray-100">Mitra</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    <a href="kelolaAdmin.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        <svg class="flex-shrink-0 w-6 h-6 text-gray-50 transition duration-75 group-hover:text-gray-900" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
		...
		l14.93-21.323c16.427,11.515,27.145,30.55,27.145,52.116C359.011,277.21,330.546,305.684,295.404,305.708z" />
                ...
                <li>
                    <a href="login-admin.php" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-50 transition duration-75 group-hover:text-gray-900"
        ...
        <div class="flex items-center justify-center">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                ...
                <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                    ...
                    <div class="mt-8">
                        <p class="text-xl font-semibold my-2">4.750</p>
                        <div class="flex space-x-2 text-gray-400 text-sm">
                            <p>Total Pengguna</p> 
                        </div>
                        <!-- flex container for bottom left corner -->
                        <div class="absolute bottom-0 left-0 mb-5 ml-6 flex items-center">
                            <!-- down arrow svg -->
                            ...
                            <p class="text-base text-gray-400 font-semibold">34%</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                    <div class="text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-green-500 left-4 -top-6">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M17 7c0 1.1-0.9 2-2 2h-1v2h1c1.1 0 2 0.9 2 2v2h-4v-2c0-1.1-0.9-2-2-2h-2c-1.1 0-2 0.9-2 2v2H3v-2c0-1.1 0.9-2 2-2h1V9H5C3.9 9 3 8.1 3 7V5h4v2c0 1.1 0.9 2 2 2h2c1.1 0 2-0.9 2-2V5h4v2zM7 5V3h2v2H7zm4 0V3h2v2h-2z" />
                        </svg>
                    </div>
                    <div class="mt-8">
                        <p class="text-xl font-semibold my-2">10</p>
                        <div class="flex space-x-2 text-gray-400 text-sm">
                            <p>Total Mitra</p> 
                        </div>
                        <!-- flex container for bottom left corner -->
                        <div class="absolute bottom-0 left-0 mb-5 ml-6 flex items-center">
                            ...
                            <p class="text-base text-gray-400 font-semibold">50%</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                    <div class="text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-blue-500 left-4 -top-6">
                        <!-- trash svg -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M6.707 4.707a1 1 0 0 1-1.414-1.414l1-1a1 1 0 0 1 1.414 0h3.172a1 1 0 0 1 .707.293l1 1a1 1 0 0 1-1.414 1.414L11 4.414H9l-.293.293z" clip-rule="evenodd" />
                            <path fill-rule="evenodd" d="M4 8a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1z" clip-rule="evenodd" />
                            <path d="M7 10h6v6a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-6z" />
                        </svg>
                    </div>
                    <div class="mt-8">
                        <p class="text-xl font-semibold my-2">20.123</p>
                        <div class="flex space-x-2 text-gray-400 text-sm">
                            <p>Total Jemput Sampah</p> 
                        </div>
                        <!-- flex container for bottom left corner -->
                        <div class="absolute bottom-0 left-0 mb-5 ml-6 flex items-center">
                            <!-- up arrow svg -->
                            ...
                            <p class="text-base text-gray-400 font-semibold">22%</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                    ...
                    <div class="mt-8">
                        <p class="text-xl font-semibold my-2">-</p>
                        <div class="flex space-x-2 text-gray-400 text-sm">
                            <p>-</p> 
                        </div>
