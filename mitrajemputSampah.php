...
$jemputssampah = $jemputsampah->getJemputSampah($mitra);
...
<head>
    ...
    <title>Mitra-Kelola Jemput Sampah</title>
...
<!-- Navigation Bar -->
<nav class="relative bg-transparent backdrop-filter z-50">
                <div class="mx-auto max-w-7xl px-4 sm:px-0">
                    <div
                        class="flex h-[100px] items-center justify-between fixed w-full z-20 top-0 start-0 px-28 shadow-lg">
                        ...
                        <div>
                            <div class="hidden md:block">
                                <div class="flex items-baseline justify-center space-x-10">
                                    ...
                                    <a href="home-mitra.php"
                                        class="text-white hover:border-b-2 px-3 py-2 text-md font-semibold focus:outline-none">Beranda</a>
                                    <div class="relative">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center px-4 text-center">
                <h1 class="text-white text-4xl md:text-4xl lg:text-5xl font-bold mb-4">Sudah Jemput Sampah?</h1>
...
<body class="bg-white">
    <div class="flex justify-center items-center max-w-6xl mx-auto bg-white p-8 rounded-md mt-7">
        <table class="w-full text-sm text-left text-gray-500" id="bukti">
            <thead class="text-xs text-white uppercase bg-cyan-800">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">kertas</th>
                    <th scope="col" class="px-6 py-3">plastik</th>
                    <th scope="col" class="px-6 py-3">kaca</th>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap"><?= $jemputsampah->id ?></th>
                    <td class="px-6 py-4"><?= $jemputsampah->nomorTelepon ?></td>
                    <td class="px-6 py-4"><?= $jemputsampah->alamat ?></td>
                    <td class="px-6 py-4"><?= $jemputsampah->tanggalPenjemputan ?></td>
                    <td class="px-6 py-4"><?= $jemputsampah->waktuPenjemputan ?></td>
                    <td class="px-6 py-4"><?= $jemputsampah->catatan ?></td>
                    <td class="px-6 py-4"><?= $jemputsampah->bskertas ?></td>
                    <td class="px-6 py-4"><?= $jemputsampah->bsplastik ?></td>
                    <td class="px-6 py-4"><?= $jemputsampah->bskaca ?></td>
                    <td class="px-6 py-4">
                        <div class="flex justify-center">
                        <?php if(empty($jemputsampah->gambar)): ?>
                            <button class="text-white bg-cyan-700 px-5 md:mx-2 text-center py-1.5 rounded-md hover:bg-cyan-600 font-bold">
                                <a href="buktiPenjemputan.php?id=<?= $jemputsampah->id ?>">Bukti</a>
                            </button>
                        <?php else: ?>
                            <img src="<?= $jemputsampah->gambar ?>" alt="Bukti Gambar">
                        <?php endif; ?>
                        </div>
                    </td>
                </tr>
