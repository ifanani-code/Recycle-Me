        ...
        <div class="relative rounded-3xl bg-white lg:w-2/5 md:h-fit px-16 md:my-10 md:mx-96 sm:px-16 sm:py-0">
            <form action="" method="post">
                <div class=" border-b border-gray-900/10 pb-3">
                    <h2 class="mt-9 text-center text-3xl font-bold text-cyan-700">Daftar</h2>
                    <div class=" grid grid-cols-1 gap-x-3 gap-y-3 sm:grid-cols-6">
                        ...
                        <p class="col-span-full text-sm font-light text-gray-500 py-1.5">
                            Sudah punya akun?
                            <a href="login.php" class="font-medium text-cyan-600 hover:underline">Masuk</a>
                            atau <a href="regist-mitra.php" class="font-medium text-cyan-600 hover:underline">Daftar sebagai mitra</a>
                        </p>
                    </div>
            </form>
        </div>
