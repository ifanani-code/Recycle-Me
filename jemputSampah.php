...
$jenissampahh = new jenisSampah();
$jenissampah = $jenissampahh->getAllJenisSampah();

$poinjenissampahh = new poinjenisSampah();
$poinjenissampah = $poinjenissampahh->getAllPoinSampah();

$email = $_SESSION["email"];
$user = new User();
$data = $user->getAllMitra();
// var_dump($data);
$max_content_char = 50;
?>
<!DOCTYPE html>
...
<body class="bg-cyan-950">
    <!-- Section 1: Layered Photo with Navigation -->
    <div class="relative">
        <!-- Photo and Overlay -->
        ...
        <div class="absolute inset-0 bg-black bg-opacity-50">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center px-4 text-center">
                ...
                <p class="text-white text-lg md:text-xl font-semibold">Gunakan layanan jemput sampah, pengepul sampah
                    akan <br> menjemput sampahmu</p>
            </div>
        </div>
    </div>
    <div class="absolute bottom-5 left-1/2 transform -translate-x-1/2">
        <a href="#jenisSampah"><svg class="h-8 w-8 text-white animate-bounce" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="p-20 bg-white">
        <div class="mx-auto max-w-screen-xl">
            <h2 class="text-4xl text-center font-bold text-cyan-950 pb-10 sm:text-6xl">Mitra Kami</h2>
            ...
            <!-- Poin -->
                <div
                    ...
                    <img class="rounded-xl" src="upload/pp/<?= $data->foto ?>" alt="" />
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="mt-5 text-2xl font-semibold"><?= $data->nama ?></h1>
                            <p class="mt-2"><?= $data->alamat ?></p>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
    ...
    <div class="container mx-auto px-4 py-8 bg-cyan-950" id="jenisSampah">
        <h2 class="text-4xl text-center font-bold text-white sm:text-6xl">Jenis Sampah</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <?php foreach ($jenissampah as $jenissampah) : ?>
            <!-- Card -->
            <div class="container flex justify-center">
                <div class="max-w-sm py-8">
                    <div
                        class="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg text-justify">
                        <img class="rounded-t-lg" src="<?= $jenissampah->gambar ?>" alt="Kertas" />
                        <div class="py-6 px-8 rounded-lg bg-white">
                            <h1 class="text-gray-700 font-bold text-2xl mb-3 hover:text-gray-900 hover:cursor-pointer">
                            <?= $jenissampah->jenissampah ?></h1>
                            <p class="text-gray-700 tracking-wide"><?= $jenissampah->deskripsi ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Section 3: Poin Section -->
    <div class="p-20 bg-white">
        <div class="mx-auto max-w-screen-xl">
            <h2 class="text-4xl text-center font-bold text-cyan-950 pb-10 sm:text-6xl">Poin yang didapatkan</h2>
            <div class="flex justify-between">
            <?php foreach ($poinjenissampah as $poinjenissampah) : ?>
            <!-- Poin -->
                <div
                    class="container mx-auto p-9 bg-white max-w-sm rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition duration-300">
                    <img class="rounded-xl" src="<?= $poinjenissampah->gambar ?>" alt="" />
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="mt-5 text-2xl font-semibold"><?= $poinjenissampah->poin ?> RPM</h1>
                            <p class="mt-2">Per Kg untuk <?= $poinjenissampah->jenissampah ?></p>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
    ...
    <div class="mx-auto px-4 py-60 bg-cyan-950 mx" id="aturjadwal">
        <h2 class="text-4xl sm:text-5xl font-bold text-white text-center">Butuh Kami Jemput Sampah Anda?</h2>
        <p class="text-xl sm:text-2xl text-white mt-4 mb-6 text-center">
            Kami siap membantu Anda dalam mengelola sampah. <br>Klik tombol di bawah ini untuk mengatur jadwal
            penjemputan.
        </p>
        <div class="grid justify-center text-center gap-y-4">
            <a href="formjemputsampah2.php"
                class="bg-cyan-700 hover:bg-cyan-600 text-white hover:text-white font-bold py-2 px-4 rounded">
                Atur Jadwal Penjemputan
            </a>
            <a href="riwayatjemputSampah.php"
                class="bg-cyan-700 hover:bg-cyan-600 text-white hover:text-white font-bold py-2 px-4 rounded">
                Riwayat</a>
        </div>
    </div>
