...
if (isset($_POST['regist'])) {
    ...
    if ($cek === true) {
        if ($password === $password2) {
            ...
            header("Location: tambah-konsumen.php");
        }
    } else {
        NotificationManager::setAlert(
            "danger",
...
<body>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg group hover:bg-gray-100">
                        ...
                        <span class="flex-1 ms-3 text-gray-100 group-hover:text-gray-900">Inbox</span>
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-cyan-800 group-hover:text-white bg-cyan-200 group-hover:bg-gray-900 rounded-full">3</span>
                    </a>
                </li>
                <li id="kelola-admin">
    ...
    <div class="ml-64">
        ...
        <div class="flex justify-center">
            <div class="p-5 w-full md:max-w-xl md:px-0">
                <h1 class="text-center text-cyan-700 font-bold text-3xl pt-5 pb-10">Tambah Konsumen</h1>
                <form method="post" action="">
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            <label for="first_name" class="text-gray-900 block mb-2 text-sm font-medium">Nama </label>
                            <input type="text" name="name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="John" required>
                        </div>
                        <div>
                            <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900">No. Hp</label>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="address"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="jl. Sukapura No.09" required>
                    </div>
                    <div class="mb-6">
                    ...
                    <button type="submit" name="regist"
                        class="text-white bg-cyan-700 hover:bg-cyan-800 focus:ring-2 focus:ring-white font-medium rounded-md text-sm w-full sm:w-auto p-2 text-center">Tambah</button>
                    <a href="kelola-konsumen.php"
                        class="text-white bg-cyan-700 hover:bg-cyan-800 focus:ring-2 focus:ring-white font-medium rounded-md text-sm w-full sm:w-auto p-2 text-center">Kembali</a>
                </form>
            </div>
        </div>
    </div>
