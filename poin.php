...
<body>
    ...
    <nav class="relative sticky top-0 bg-transparent backdrop-filter shadow-lg">
    ...
    <!-- end of nav-bar -->
        ...
        <div class="grid auto-rows-min gap-y-6 relative mx-auto justify-center items-start max-w-7xl h-fit px-6 py-2 lg:py-16 lg:px-8">
            <h2 class="relative md:text-white text-6xl text-center font-semibold animate__animated animate__fadeInDown">Poin Saya</h2>
            <p class="text-white text-xl text-center max-w-3xl animate__animated animate__fadeInDown animate__delay-1s">
                Poin Anda adalah cara untuk mendapatkan lebih banyak dari Recycle Me. Dapatkan poin untuk setiap jemput sampah, artikel yang Anda baca, dan banyak lagi. Tukar poin Anda menjadi uang hari ini!
            </p>
            <div class="bg-white/90 max-w-md px-6 md:max-w-3xl pt-5 pb-4 rounded-xl animate__animated animate__fadeInDown">
                <dl class="grid gap-y-16 gap-x-5 text-center md:grid-cols-3 w-lg">
                    <div class="flex w-xs flex-col gap-y-4 px-3 rounded-lg py-3 border border-cyan-800 shadow-xl text-cyan-700">
                        <dt class="text-base leading-7 ">Total Poin</dt>
                        <dd class="order-first text-3xl font-semibold tracking-tight sm:text-4xl">50000
                        </dd>
                    </div>
                    <div class="flex w-xs flex-col gap-y-4 px-3 rounded-lg py-3 border border-cyan-800 shadow-xl text-cyan-700">
                        <dt class="text-base leading-7">Poin yang sudah ditukar</dt>
                        <dd class="order-first text-3xl font-semibold tracking-tight sm:text-4xl">10000
                        </dd>
                    </div>
                    <div class="flex w-xs flex-col gap-y-4 px-3 rounded-lg py-3 border border-cyan-800 shadow-xl text-cyan-700">
                        <dt class="text-base leading-7">Poin yang tersedia</dt>
                        <dd class="order-first text-3xl font-semibold tracking-tight sm:text-4xl"><?= $data->poin ?>
                        </dd>
                    </div>
                </dl>
                <div class="grid grid-cols-3">
                    <div></div>
                    <div class="grid grid-rows-1  gap-y-3 mt-4">
                        <a href="tukar-poin.php"
                            class="bg-cyan-700 hover:bg-cyan-600 py-2 px-8 text-white font-semibold text-center rounded-lg">Tukar</a>
                    </div>
                </div>
                <a href="riwayat-poin.php" class="text-cyan-700 hover:underline">Riwayat</a>
            </div>
        </div>

    <footer class="relative p-20 bg-gray-900">
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="#" class="flex items-center">
                        <img src="assets/bg rm.png" class="h-[100px]" alt="FlowBite Logo" />
                    </a>
                </div>
