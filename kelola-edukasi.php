        ...
        C285.563,81.188,120.842,80.939,120.842,206.782z" />
                ...
                <li>
                    <button class="w-full flex items-center p-2 text-gray-900 rounded-lg bg-white group"
                        ...
                        <span class="flex-1 ms-2 text-gray-900 text-left">Kelola Artikel</span>
        ...
        <div class="container ">
            ...
            <div class=" container relative overflow-x-auto">
                <div class="mb-5 flex sm:w-3xl">
                        ...
                        <div class="pl-80 ml-28 pt-4">
                            <form method="GET" action="hasil-pencarian-edukasi.php" class="">
                                <label for="keyword" class="block text-cyan-700 text-sm font-bold ">Masukkan Kata Pencarian:</label>
                        ...
                        <tbody>
                            <tr class="bg-white border-b text-black ">
                                ...
                                <td class="flex px-4 py-12 ">
                                    <a href="edit-post.php?id=<?= $data->id ?>" class="font-medium text-white bg-cyan-700 hover:bg-cyan-600 py-1.5 px-2 rounded-md mr-1">Ubah</a>
                                    <a href="hapus-post.php?id=<?= $data->id ?>" class="font-medium text-white bg-red-500 hover:bg-red-400 py-1.5 px-2 rounded-md">Hapus</a>
                                </td>
                            </tr>
                        </tbody>
                        <?php endforeach; ?>
