...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $user->updateUser($id, $name, $phone, $address);
    if ($result == true) {
                ...
                <li>
                    ...
                    <div id="dropdown-artikel"
                        ...
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100">Edukasi</a>
                            </li>
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100">Berita</a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    <div class="ml-60">
        <div class="flex w-full pt-10 justify-center">
            <form action="" method="post">
                ...
                <h1 class="text-center text-cyan-700 font-bold text-4xl pt-5 pb-10">Edit Konsumen</h1>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-4">
                        <div class="sm:col-span-4">
                            <label for="username" class="text-gray-800 block mb-2 text-sm font-medium">Email</label>
                            <div class="mt-2">
                                <div
                                    class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input type="email" name="email" value="<?= $data->email ?>" disabled
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed">
                                </div>
                            </div>
                        </div>
                        <div class="sm:col-span-4">
                            <label for="username" class="text-gray-800 block mb-2 text-sm font-medium">Role</label>
                            <div class="mt-2">
                                <div
                                    class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input type="text" name="mitra" disabled value="<?= $data->role ?>"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed">
                                </div>
                            </div>
                        </div>
                        <div class="sm:col-span-4">
                            <label for="username" class="text-gray-800 block mb-2 text-sm font-medium">Nama</label>
                            <div class="mt-2">
                                <div
                                    class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        ...
                        <div class="sm:col-span-4">
                            <label for="username" class="text-gray-800 block mb-2 text-sm font-medium">No. Hp</label>
                            <div class="mt-2">
                                <div
                                    class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        ...
                        <div class="sm:col-span-4">
                            <label for="username" class="text-gray-800 block mb-2 text-sm font-medium">Alamat</label>
                            <div class="mt-2">
                                <div
                                    class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input type="text" name="address" value="<?= $data->alamat ?>"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                </div>
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-x-2">
                            <button type="submit" name="simpan"
                                class="font-medium rounded-md px-2 py-1.5 text-white text-center bg-cyan-800 hover:bg-cyan-700">Simpan</button>
                            <a href="kelola-konsumen.php"
                                class="font-medium rounded-md px-2 py-1.5 text-white text-center bg-cyan-800 hover:bg-cyan-700">Kembali</a>
                        </div>
                    </div>
            </form>
