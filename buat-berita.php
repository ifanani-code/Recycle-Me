     ...
     if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($file_tmp, $saveFile)) {
            ...
            if (rename($saveFile, $newFilePath)) {
                ...
                $berita = new Berita();
                $result = $berita->buatBerita($data->title, $data->subtitle, $data->content, $data->image);
...
<nav class="relative bg-transparent backdrop-filter pt-24 ">
            ...
            <div class="space-y-12 ">
                <div class="border-b border-gray-900/10 pb-12 ">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4">
                            <label for="subjudul" class="block text-base font-semibold leading-6 text-gray-900">SubJudul</label>
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full">
                        ...
                        <div class="col-span-5">
                            <label for="konten" class="block text-base font-semibold leading-6 text-gray-900">Konten Berita</label>
                            <div class="mt-2">
                            ...
                            <p class="mt-3 text-sm leading-6 text-gray-600">Masukkan konten berita disini.</p>
                        </div>
                        <div class="col-span-full max-w-5xl">
                            <label for="foto" class="block text-base font-semibold leading-6 text-gray-900">Foto Berita</label>
                            <div class="mt-2 flex justify-center rounded-lg border border border-gray-900/25 px-6 py-10 w-[600px]">
                                <div class="text-center">
                                    ...
                                    <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                        <label for="foto" class="relative cursor-pointer rounded-md bg-white font-semibold text-cyan-700 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-cyan-600">
        ...
        <div class="mb-10">
            <button type="submit" class=" bg-cyan-700 text-white font-semibold p-3 rounded-lg  shadow-md hover:bg-cyan-600" href="edukasi.php">Buat Berita</button>
        </div>
    </div>
    </div>
    <script>
