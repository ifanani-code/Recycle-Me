                ...
                <?php foreach ($dataBerita as $data): ?>
                    <div class="relative border-gray-200 rounded-lg shadow-lg bg-cyan-700 dark:border-gray-200 w-7xl mb-4">
                        ...
                        <div class="px-6">
                            ...
                            <a href="view-berita-before.php?id=<?= $data->id_berita ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-cyan-800 rounded-lg hover:bg-cyan-600 focus:ring-4 focus:outline-none mb-4">
                                Baca selengkapnya
                            </a>
